...
from dataset import ds_course,web_course,android_course,ios_course,uiux_course,resume_videos,interview_videos
import nltk
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Samsulekismygoat111409',db='cv')
...
def run():
    ...
    #img = Image.open('./Logo/ats.png')
    #st.image(img)
    st.sidebar.markdown("# Who are You?")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose your role among these:", activities)
    link = '' 
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            with st.spinner('Hang On While We are Cooking...'):
                time.sleep(4)
        

            save_image_path = './data/resume/'+pdf_file.name
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.subheader("**Respins (RESUME PINS)**")

        st.markdown('''

        <p align='justify'>
           Respins is a powerful tool designed to parse information from resumes using natural language processing. It identifies relevant keywords, organizes them into industry-specific clusters, and provides personalized recommendations, predictions, and analytics based on keyword matching.
        </p>

        <p align="justify">
            <b>How to Use: -</b> <br/><br/>
            <b>User: </b> <br/>
            ㆍNavigate to the sidebar, select the "User" option, and fill in the required details.<br/>
            ㆍUpload your resume in PDF format.<br/>
            ㆍSit back and relax while our tool cooks it for you, analyzing your resume effortlessly.<br/><br/>
            <b>Feedback: </b> <br/>
            ㆍShare your valuable suggestions and feedback about the tool in the Feedback section.<br/><br/>
            <b>Admin: </b> <br/>
            Log in using the following credentials:<br/>
            ㆍ<b>Username:</b> admin <br/>
            ㆍ<b>Password:</b> admin123 <br/>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin123':
                ...
                st.success("Welcome Nagulan ! Total %d " % values + " User's Have Used the tool")                
